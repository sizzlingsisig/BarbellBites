...
import { RegisterRequest, LoginRequest, ForgotPasswordRequest } from '../../requests/v2/authRequests.js'
import { protect } from '../../middleware/authMiddleware.js'


const router = Router()
router.post('/forgot-password', validate(ForgotPasswordRequest), authController.forgotPassword)
